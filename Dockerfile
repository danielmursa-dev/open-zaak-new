...
COPY --from=frontend-build /app/src/openzaak_new/static /app/src/openzaak_new/static
...
ENV RELEASE=${RELEASE} \
    GIT_SHA=${COMMIT_HASH} \
    PYTHONUNBUFFERED=1 \
    DJANGO_SETTINGS_MODULE=openzaak_new.conf.docker

ARG SECRET_KEY=dummy

LABEL org.label-schema.vcs-ref=$COMMIT_HASH \
      org.label-schema.vcs-url="https://github.com/maykinmedia/openzaak_new" \
      org.label-schema.version=$RELEASE \
      org.label-schema.name="openzaak_new"

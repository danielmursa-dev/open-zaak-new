...
from openzaak_new.accounts.views.password_reset import PasswordResetView
...
admin.site.site_header = "openzaak_new admin"
admin.site.site_title = "openzaak_new admin"
admin.site.index_title = "openzaak_new dashboard"

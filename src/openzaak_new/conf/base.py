...
ROOT_URLCONF = "openzaak_new.urls"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "openzaak_new.utils.context_processors.settings",
            ],
...
WSGI_APPLICATION = "openzaak_new.wsgi.application"
...
DEFAULT_FROM_EMAIL = "openzaak_new@example.com"
...
LOGGING = {
    ...
    "handlers": {
        ...
        "project": {
            "level": "DEBUG",
            "class": "logging.handlers.RotatingFileHandler",
            "filename": LOGGING_DIR / "openzaak_new.log",
            "formatter": "verbose",
            "maxBytes": 1024 * 1024 * 10,  # 10 MB
            "backupCount": 10,
        },
...
AUTHENTICATION_BACKENDS = [
    ...
    "openzaak_new.accounts.backends.UserModelEmailBackend",
    "django.contrib.auth.backends.ModelBackend",
]

SESSION_COOKIE_NAME = "openzaak_new_sessionid"
...
CSRF_FAILURE_VIEW = "openzaak_new.accounts.views.csrf_failure"
...
TWO_FACTOR_WEBAUTHN_RP_NAME = "openzaak_new"
...
ELASTIC_APM = {
    "SERVICE_NAME": f"openzaak_new {ENVIRONMENT}",

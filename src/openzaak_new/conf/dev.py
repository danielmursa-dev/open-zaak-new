...
os.environ.setdefault(
    "SECRET_KEY",
    "django-insecure-%@6wccg*r1(1is#i)m3q34pa25_&0n-h(2tp#q(r9*0z4%jk5x",
)
os.environ.setdefault("IS_HTTPS", "no")
os.environ.setdefault("VERSION_TAG", "dev")

os.environ.setdefault("DB_NAME", "openzaak_new")
os.environ.setdefault("DB_USER", "openzaak_new")
os.environ.setdefault("DB_PASSWORD", "openzaak_new")
